    ...
    <>
      ...
      <section className={styles.text}>
        <div className={styles.paragraph}>
          <p>
            Ние сме търговско дружество опериращо на територията на град София,
          ...
          <p>
            За всяка една кола, която купуваме, издаваме документи за бракуване,
      ...
      <section className={styles.text}>
        <div className={styles.paragraph}>
          <p>
            ...
            Вас начин за връзка с нас - може да ни се обадите по телефона, може

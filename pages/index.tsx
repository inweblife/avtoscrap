...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Коли за скрап София | Изкупуване и Безплатен транспорт</title>
        <meta
          name="description"
          content="Изкупуване на коли за скрап в София. Безплатен транспорт от адрес, плащане в брой, удостоверение за дерегистрация. Работим 7 дни в седмицата."
        />
        <meta
          name="keywords"
